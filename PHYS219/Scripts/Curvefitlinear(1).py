...
fname = '/Users/ryank/Desktop/Work/Classes/Python/PHYS219/Experiment 4/HighFreqGain.csv'
...
plt.xlabel('{} [{}]'.format(x_name,x_units))
plt.ylabel('{} [{}]'.format(y_name,y_units))
plt.title(r'Linear fit of High Frequency Operational Amplifiers')
