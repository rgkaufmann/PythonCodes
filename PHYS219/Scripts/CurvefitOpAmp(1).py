...
fname = '/Users/ryank/Desktop/Work/Classes/Python/PHYS219/Final Experiment/ChangingResistance.csv'
...
plt.xlabel('{} [{}]'.format(x_name,x_units))
plt.ylabel('{} [{}]'.format(y_name,y_units))
plt.title(r'Gain as a Function of Frequency for 4.7 Gain Setup')
