...
fname = 'C:/Users/ryank/Desktop/Work/Python/PHYS219/Experiment 3/I-VCurve.csv'
...
def fit_function(x, I0, kBovere, offset):
    return  np.abs(I0*(np.exp(x/(kBovere*T))-1))+offset
...
plt.xlabel('{} [{}]'.format(x_name,x_units))
plt.ylabel('{} [{}]'.format(y_name,y_units))
plt.title(r'Fitted Equation for Diode Voltage versus Current')
