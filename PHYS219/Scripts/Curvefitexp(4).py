...
fname = '/Users/ryank/Desktop/Work/Python/PHYS219/Experiment 1/RCSquareCapacitorVoltage10kOhmReduced.csv'
#fname = 'Newfile1.csv'
...
plt.title(r'Exponential Relationship Between Voltage and Time')
